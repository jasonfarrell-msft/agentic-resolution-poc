...
SYSTEM_PROMPT = """You are an IT service request data retriever. Your job is to fetch the full ticket details and return them in structured format for downstream processing.
